...
void TCBM_Commands::Channel::Close()
{
	if (open)
	{
		if (writing)
...
void TCBM_Commands::CloseAllChannels()
{
	for (int i = 0; i < 15; ++i)
	{
		channels[i].Close();
...
bool TCBM_Commands::Enter(DIR& dir, FILINFO& filInfo)
{
...
void TCBM_Commands::CD(int partition, char* filename)
{
...
void TCBM_Commands::MKDir(int partition, char* filename)
{
	char filenameEdited[256];
...
void TCBM_Commands::FolderCommand(void)
{
	Channel& channel = channels[15];
...
void TCBM_Commands::ChangeDevice(void)
{
	Channel& channel = channels[15];
	const char* text = (char*)channel.buffer;
...
void TCBM_Commands::Memory(void)
{
	Channel& channel = channels[15];
...
void TCBM_Commands::Rename(void)
{
...
void TCBM_Commands::Scratch(void)
{
...
void TCBM_Commands::Extended(void)
{
	Channel& channel = channels[15];
...
void TCBM_Commands::ProcessCommand(void)
{
	Error(ERROR_00_OK);
...
bool TCBM_Commands::FindFirst(DIR& dir, const char* matchstr, FILINFO& filInfo)
{
	char pattern[256];
	FRESULT res;
...
bool TCBM_Commands::SendBuffer(Channel& channel, bool eoi)
{
...
u8 TCBM_Commands::GetFilenameCharacter(u8 value)
{
...
void TCBM_Commands::AddDirectoryEntry(Channel& channel, const char* name, u16 blocks, int fileType)
{
...
void TCBM_Commands::CloseFile(u8 secondary)
{
	Channel& channel = channels[secondary];
...
int TCBM_Commands::CreateNewDisk(char* filenameNew, char* ID, bool automount)
{
...
int TCBM_Commands::WriteNewDiskInRAM(char* filenameNew, bool automount, unsigned length)
{
	FILINFO filInfo;
	FRESULT res;
