...
// 1551 needs also 8-bit CPU port at $00 (DDR) / $01 (PORT)
...
// Many comments in this file are taken from statements found in the 6523 data sheets.
...
void m6523::InputCA1(bool value)
{
...
void m6523::InputCA2(bool value)
{
...
void m6523::InputCB1(bool value)
{
...
void m6523::InputCB2(bool value)
{
...
void m6523::Execute()
{
	...
	switch (shiftMode)
	{
		...
		case 2:		// 010 = shift in by phi2
			...
			// In both the shift in and shift out modes a liming condition may occur when the 6523 does not detect the shift pulse.
...
void m6523::Write(unsigned int address, unsigned char value)
{
	...
	switch (address & 0xf)
	{
		...
		case T1LH:
			...
			// The designers of the 6523 allow this mode by clearing the T1 interrupt triggering when T1LH is written to.
